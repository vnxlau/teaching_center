  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/student/attendance?startDate=${startDate}&endDate=${endDate}`
      )
      if (response.ok) {
        const data = await response.json()
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">View your information and attendance records</p>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700">My Monthly Amount</label>
                    <p className="mt-1 text-sm text-gray-900">
