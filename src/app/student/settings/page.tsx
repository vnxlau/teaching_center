        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">
              <strong>Note:</strong> Academic information such as grade level and enrollment details can only be updated by school administrators.
            </p>
            <p className="text-sm text-gray-600">
              If you need to update any academic information, please contact the school administration or speak with your teacher.
            </p>
          </div>
        </div>
